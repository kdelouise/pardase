	...
	<!-- jQuery Plugins -->
		...
		<script src="<?php echo DIR_JS; ?>plugins/PhoneFormat.js"></script>
		<script src="<?php echo DIR_JS; ?>plugins/intlTelInput.js"></script>
		<script src="<?php echo DIR_JS; ?>plugins/validation.js"></script>
